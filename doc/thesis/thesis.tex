...
\subsection{Shrnutí výsledků dotazníku}
...
Celkový propad Basecampu a jiného groupware ve výsledcích zcela koresponduje s neochotou zájmových skupin organizovat se sofistikovaněji (viz \ref{noOrganization}).
