...
% RP: Závěrečná kapitola obsahuje zhodnocení dosažených výsledků se zvláštním důrazem na vlastní přínos a zhodnocení z širšího pohledu na řešenou problematiku. V závěru je vhodné uvést i možné směry dalšího výzkumu či vývoje.
