...
Následující odstavce představují aplikační rozhraní, jež je potřeba využít pro tvorbu zadaného programu, a vysvětluje související pojmy. Výčet nezahrnuje protokol SMTP jakožto rozhraní pro interakci s uživateli prostého e-mailu, protože je jeho problematika po desetiletí neměnná a nepřipravuje pro návrh či implementaci výrazné překážky.
...
\begin{description}
    ...
    \item[makefile] Soubor {\tt makefile} usnadňující některé systémové úkony nad kódem ukázkové aplikace.
