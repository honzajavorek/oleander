...
\chapter{Závěr}
Práce je zadána na základě doměnky z reálného prostředí, že by bylo užitečné propojit různé internetové komunikační kanály za účelem snazší organizace malých skupin. Cílem je tedy tuto doměnku ověřit. Hlavním přínosem práce by měla být široká analýza možností integrace jednotlivých druhů dorozumívání a poukázání na takové případy, jež je možné realizovat jako webovou aplikaci s potenciálem najít si své uživatele.
